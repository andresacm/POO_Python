...
class HighSchoolStudent(Student):
    ...
    def __str__(self):
        return f"Estudiante: {self.__name}. Colegio: {self.__schoolName}, grado: {self.__grade}"
...
class CollegeStudent(Student):
    ...
    def __str__(self):
        return f"Estudiante: {self.__name}. Universidad: {self.__universityName}, Periodo: {self.__period}"
